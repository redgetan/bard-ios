...
//    var packToken: String!
    ...
    // this is used in fetching wordtags for packeditor (all scenes)
    // it is also used for checking whether word is valid (in dictionary), regardless of whether its packeditor or sceneeditor
...
//        NSNotificationCenter.defaultCenter().removeObserver(self, name: UITextViewTextDidChangeNotification, object: inputTextField)
    ...
    func initCollectionView() {
        ...
        wordTagCollectionView.contentInset=UIEdgeInsetsMake(10.0,10.0,10.0,40.0)
